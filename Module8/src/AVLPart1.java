 ...
 */
public class AVLPart1<T extends Comparable<? super T>> {
    ...
    public void updateHeightAndBF(AVLNode<T> currentNode) {
        ...
        //height is max height of the children + 1
        //BF is left child height - right child height
        //both children are null, height is 0, children height are -1
        //left child is null, height is right child height + 1
        //
        int left;
        if (currentNode.getLeft() != null){
            left = currentNode.getLeft().getHeight();
        }
        else{
            left = -1;
        }
        ...
        if (currentNode.getRight() != null){
            right = currentNode.getRight().getHeight();
        }
        else{
            right = -1;
        }
        currentNode.setHeight(Math.max(left, right) + 1);
        currentNode.setBalanceFactor(left - right);
          }
